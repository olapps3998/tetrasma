	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["detail_id"] <> "") {
				...
				$sReturnUrl = "t_detaillist.php"; // Return to list
			}
...
ft_detailview.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_nama_akun","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"v_akun_jurnal"};
ft_detailview.Lists["x_anggota_id"] = {"LinkField":"x_anggota_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_anggota"};
...
<?php if ($t_detail->akun_id->Visible) { // akun_id ?>
	<tr id="r_akun_id">
		<td><span id="elh_t_detail_akun_id"><?php echo $t_detail->akun_id->FldCaption() ?></span></td>
...
<?php echo $t_detail->akun_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_detail->nilai->Visible) { // nilai ?>
	<tr id="r_nilai">
		<td><span id="elh_t_detail_nilai"><?php echo $t_detail->nilai->FldCaption() ?></span></td>
...
<?php echo $t_detail->nilai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
