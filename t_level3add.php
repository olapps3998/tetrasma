...
$t_level3_add = NULL; // Initialize page object first

class ct_level3_add extends ct_level3 {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_level3view.php")
...
// Create page object
if (!isset($t_level3_add)) $t_level3_add = new ct_level3_add();

// Page init
$t_level3_add->Page_Init();

// Page main
$t_level3_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_level3_add->Page_Render();
?>
...
var CurrentForm = ft_level3add = new ew_Form("ft_level3add", "add");

// Validate form
ft_level3add.Validate = function() {
...
ft_level3add.Form_CustomValidate = 
...
ft_level3add.ValidateRequired = true;
<?php } else { ?>
ft_level3add.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_level3add.Lists["x_level1_id"] = {"LinkField":"x_level1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level1_no","x_level1_nama","",""],"ParentFields":[],"ChildFields":["x_level2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level1"};
ft_level3add.Lists["x_level2_id"] = {"LinkField":"x_level2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level2_no","x_level2_nama","",""],"ParentFields":["x_level1_id"],"ChildFields":[],"FilterFields":["x_level1_id"],"Options":[],"Template":"","LinkTable":"t_level2"};
...
<?php } ?>
<?php $t_level3_add->ShowPageHeader(); ?>
<?php
$t_level3_add->ShowMessage();
?>
<form name="ft_level3add" id="ft_level3add" class="<?php echo $t_level3_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_level3_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_level3_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ft_level3add.CreateAutoSuggest({"id":"x_level1_id","forceSelect":true});
</script>
...
<script type="text/javascript">
ft_level3add.CreateAutoSuggest({"id":"x_level2_id","forceSelect":true});
</script>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_level3_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
