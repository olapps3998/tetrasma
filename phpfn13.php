...
function CurrentProjectID() {
	...
	return "{D8E5AA29-C8A1-46A6-8DFF-08A223163C5D}";
}
...
function Database_Connecting(&$info) {
	if (ew_CurrentUserIP() == "127.0.0.1" || ew_CurrentUserIP () == ":: 1" || ew_CurrentHost () == "localhost") { // setting koneksi database di komputer localhost
	...
	} elseif (ew_CurrentHost () == "tetrasma.nma-indonesia.com") { // setting koneksi database untuk komputer server
		...
		$info["db"] = "u945388674_tetra"; // sesuaikan dengan nama database di komputer server
	}
}
