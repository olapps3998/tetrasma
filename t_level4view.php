...
$t_level4_view = NULL; // Initialize page object first

class ct_level4_view extends ct_level4 {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_level4list.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_level4list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_level4_view)) $t_level4_view = new ct_level4_view();

// Page init
$t_level4_view->Page_Init();

// Page main
$t_level4_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_level4_view->Page_Render();
?>
...
var CurrentForm = ft_level4view = new ew_Form("ft_level4view", "view");

// Form_CustomValidate event
ft_level4view.Form_CustomValidate = 
...
ft_level4view.ValidateRequired = true;
<?php } else { ?>
ft_level4view.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_level4view.Lists["x_level1_id"] = {"LinkField":"x_level1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level1_no","x_level1_nama","",""],"ParentFields":[],"ChildFields":["x_level2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level1"};
ft_level4view.Lists["x_level2_id"] = {"LinkField":"x_level2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level2_no","x_level2_nama","",""],"ParentFields":[],"ChildFields":["x_level3_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level2"};
ft_level4view.Lists["x_level3_id"] = {"LinkField":"x_level3_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level3_no","x_level3_nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level3"};
ft_level4view.Lists["x_jurnal"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_level4view.Lists["x_jurnal"].Options = <?php echo json_encode($t_level4->jurnal->Options()) ?>;
ft_level4view.Lists["x_jurnal_kode"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_level4view.Lists["x_jurnal_kode"].Options = <?php echo json_encode($t_level4->jurnal_kode->Options()) ?>;
ft_level4view.Lists["x_neraca"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_level4view.Lists["x_neraca"].Options = <?php echo json_encode($t_level4->neraca->Options()) ?>;
ft_level4view.Lists["x_labarugi"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_level4view.Lists["x_labarugi"].Options = <?php echo json_encode($t_level4->labarugi->Options()) ?>;
...
<?php if ($t_level4->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t_level4_view->IsModal) { ?>
<?php if ($t_level4->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t_level4_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_level4_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_level4_view->IsModal) { ?>
<?php if ($t_level4->Export == "") { ?>
...
<?php } ?>
<?php $t_level4_view->ShowPageHeader(); ?>
<?php
$t_level4_view->ShowMessage();
?>
<?php if (!$t_level4_view->IsModal) { ?>
<?php if ($t_level4->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_level4_view->Pager)) $t_level4_view->Pager = new cPrevNextPager($t_level4_view->StartRec, $t_level4_view->DisplayRecs, $t_level4_view->TotalRecs) ?>
<?php if ($t_level4_view->Pager->RecordCount > 0 && $t_level4_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_level4_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_level4_view->PageUrl() ?>start=<?php echo $t_level4_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_level4_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_level4_view->PageUrl() ?>start=<?php echo $t_level4_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_level4_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_level4_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_level4_view->PageUrl() ?>start=<?php echo $t_level4_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_level4_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_level4_view->PageUrl() ?>start=<?php echo $t_level4_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_level4_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_level4view" id="ft_level4view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_level4_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_level4_view->Token ?>">
<?php } ?>
...
<?php if ($t_level4->level1_id->Visible) { // level1_id ?>
	<tr id="r_level1_id">
		<td><span id="elh_t_level4_level1_id"><?php echo $t_level4->level1_id->FldCaption() ?></span></td>
...
<?php echo $t_level4->level1_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_level4->level2_id->Visible) { // level2_id ?>
	<tr id="r_level2_id">
		<td><span id="elh_t_level4_level2_id"><?php echo $t_level4->level2_id->FldCaption() ?></span></td>
...
<?php echo $t_level4->level2_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_level4->level3_id->Visible) { // level3_id ?>
	<tr id="r_level3_id">
		<td><span id="elh_t_level4_level3_id"><?php echo $t_level4->level3_id->FldCaption() ?></span></td>
...
<?php echo $t_level4->level3_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_level4->level4_no->Visible) { // level4_no ?>
	<tr id="r_level4_no">
		<td><span id="elh_t_level4_level4_no"><?php echo $t_level4->level4_no->FldCaption() ?></span></td>
...
<?php echo $t_level4->level4_no->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_level4->level4_nama->Visible) { // level4_nama ?>
	<tr id="r_level4_nama">
		<td><span id="elh_t_level4_level4_nama"><?php echo $t_level4->level4_nama->FldCaption() ?></span></td>
...
<?php echo $t_level4->level4_nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t_level4->jurnal->Visible) { // jurnal ?>
	<tr id="r_jurnal">
		<td><span id="elh_t_level4_jurnal"><?php echo $t_level4->jurnal->FldCaption() ?></span></td>
...
<?php echo $t_level4->jurnal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_level4->jurnal_kode->Visible) { // jurnal_kode ?>
	<tr id="r_jurnal_kode">
		<td><span id="elh_t_level4_jurnal_kode"><?php echo $t_level4->jurnal_kode->FldCaption() ?></span></td>
...
<?php echo $t_level4->jurnal_kode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_level4->neraca->Visible) { // neraca ?>
	<tr id="r_neraca">
		<td><span id="elh_t_level4_neraca"><?php echo $t_level4->neraca->FldCaption() ?></span></td>
...
<?php echo $t_level4->neraca->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_level4->labarugi->Visible) { // labarugi ?>
	<tr id="r_labarugi">
		<td><span id="elh_t_level4_labarugi"><?php echo $t_level4->labarugi->FldCaption() ?></span></td>
...
<?php echo $t_level4->labarugi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
