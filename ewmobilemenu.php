...
$RootMenu->AddMenuItem(10144, "mmi_r_labarugi0_php", $Language->MenuPhrase("10144", "MenuText"), "r_labarugi0.php", 10128, "", AllowListMenu('{D8E5AA29-C8A1-46A6-8DFF-08A223163C5D}r_labarugi0.php'), FALSE, TRUE);
$RootMenu->AddMenuItem(10169, "mmi_r_neraca0_php", $Language->MenuPhrase("10169", "MenuText"), "r_neraca0.php", 10128, "", AllowListMenu('{D8E5AA29-C8A1-46A6-8DFF-08A223163C5D}r_neraca0.php'), FALSE, TRUE);
