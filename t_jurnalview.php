	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["jurnal_id"] <> "") {
				...
				$sReturnUrl = "t_jurnallist.php"; // Return to list
			}
...
ft_jurnalview.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level4_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level4"};
ft_jurnalview.Lists["x_jenis_jurnal"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_jurnalview.Lists["x_jenis_jurnal"].Options = <?php echo json_encode($t_jurnal->jenis_jurnal->Options()) ?>;
...
<?php if ($t_jurnal->akun_id->Visible) { // akun_id ?>
	<tr id="r_akun_id">
		<td><span id="elh_t_jurnal_akun_id"><?php echo $t_jurnal->akun_id->FldCaption() ?></span></td>
		<td data-name="akun_id"<?php echo $t_jurnal->akun_id->CellAttributes() ?>>
<span id="el_t_jurnal_akun_id">
<span<?php echo $t_jurnal->akun_id->ViewAttributes() ?>>
<?php echo $t_jurnal->akun_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jurnal->jenis_jurnal->Visible) { // jenis_jurnal ?>
	<tr id="r_jenis_jurnal">
		<td><span id="elh_t_jurnal_jenis_jurnal"><?php echo $t_jurnal->jenis_jurnal->FldCaption() ?></span></td>
		<td data-name="jenis_jurnal"<?php echo $t_jurnal->jenis_jurnal->CellAttributes() ?>>
<span id="el_t_jurnal_jenis_jurnal">
<span<?php echo $t_jurnal->jenis_jurnal->ViewAttributes() ?>>
<?php echo $t_jurnal->jenis_jurnal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t_jurnal->nilai->Visible) { // nilai ?>
	<tr id="r_nilai">
		<td><span id="elh_t_jurnal_nilai"><?php echo $t_jurnal->nilai->FldCaption() ?></span></td>
		<td data-name="nilai"<?php echo $t_jurnal->nilai->CellAttributes() ?>>
<span id="el_t_jurnal_nilai">
<span<?php echo $t_jurnal->nilai->ViewAttributes() ?>>
<?php echo $t_jurnal->nilai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
