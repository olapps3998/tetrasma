...
//
// Table class for t_level1
//
class ct_level1 extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't_level1';
		$this->TableName = 't_level1';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_level1`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// level1_id
		$this->level1_id = new cField('t_level1', 't_level1', 'x_level1_id', 'level1_id', '`level1_id`', '`level1_id`', 3, -1, FALSE, '`level1_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// level1_no
		$this->level1_no = new cField('t_level1', 't_level1', 'x_level1_no', 'level1_no', '`level1_no`', '`level1_no`', 200, -1, FALSE, '`level1_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->level1_no->Sortable = TRUE; // Allow sort
		$this->fields['level1_no'] = &$this->level1_no;

		// level1_nama
		$this->level1_nama = new cField('t_level1', 't_level1', 'x_level1_nama', 'level1_nama', '`level1_nama`', '`level1_nama`', 200, -1, FALSE, '`level1_nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_level1`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`level1_no` ASC";
	}
	...
	function Insert(&$rs) {
		...
		if ($bInsert) {
			...
			$rs['level1_id'] = $this->level1_id->DbValue;
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_level1view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_level1view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_level1add.php?" . $this->UrlParm($parm);
		else
			$url = "t_level1add.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_level1edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_level1add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_level1delete.php", $this->UrlParm());
	}
