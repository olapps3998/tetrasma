...
class ct_detail_edit extends ct_detail {
	...
	function Page_Main() {
		...
		if ($this->detail_id->CurrentValue == "") {
			$this->Page_Terminate("t_detaillist.php"); // Invalid key, return to list
		}
...
ft_detailedit.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_nama_akun","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"v_akun_jurnal"};
ft_detailedit.Lists["x_anggota_id"] = {"LinkField":"x_anggota_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_anggota"};
...
<script type="text/javascript">
ft_detailedit.CreateAutoSuggest({"id":"x_akun_id","forceSelect":true});
</script>
...
<script type="text/javascript">
ft_detailedit.CreateAutoSuggest({"id":"x_anggota_id","forceSelect":true});
</script>
