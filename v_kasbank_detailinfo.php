...
$v_kasbank_detail = NULL;

//
// Table class for v_kasbank_detail
//
class cv_kasbank_detail extends cTable {
	var $detail_id;
	var $jurnal_id;
	var $no_bukti;
	var $tgl;
	...
	function __construct() {
		...
		$this->TableVar = 'v_kasbank_detail';
		$this->TableName = 'v_kasbank_detail';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_kasbank_detail`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// detail_id
		$this->detail_id = new cField('v_kasbank_detail', 'v_kasbank_detail', 'x_detail_id', 'detail_id', '`detail_id`', '`detail_id`', 3, -1, FALSE, '`detail_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// jurnal_id
		$this->jurnal_id = new cField('v_kasbank_detail', 'v_kasbank_detail', 'x_jurnal_id', 'jurnal_id', '`jurnal_id`', '`jurnal_id`', 3, -1, FALSE, '`jurnal_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// no_bukti
		$this->no_bukti = new cField('v_kasbank_detail', 'v_kasbank_detail', 'x_no_bukti', 'no_bukti', '`no_bukti`', '`no_bukti`', 200, -1, FALSE, '`no_bukti`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_bukti->Sortable = TRUE; // Allow sort
		$this->fields['no_bukti'] = &$this->no_bukti;

		// tgl
		$this->tgl = new cField('v_kasbank_detail', 'v_kasbank_detail', 'x_tgl', 'tgl', '`tgl`', ew_CastDateFieldForLike('`tgl`', 0, "DB"), 133, 0, FALSE, '`tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ket
		$this->ket = new cField('v_kasbank_detail', 'v_kasbank_detail', 'x_ket', 'ket', '`ket`', '`ket`', 201, -1, FALSE, '`ket`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ket->Sortable = TRUE; // Allow sort
		$this->fields['ket'] = &$this->ket;

		// akun_id
		$this->akun_id = new cField('v_kasbank_detail', 'v_kasbank_detail', 'x_akun_id', 'akun_id', '`akun_id`', '`akun_id`', 3, -1, FALSE, '`akun_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// debet
		$this->debet = new cField('v_kasbank_detail', 'v_kasbank_detail', 'x_debet', 'debet', '`debet`', '`debet`', 20, -1, FALSE, '`debet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kredit
		$this->kredit = new cField('v_kasbank_detail', 'v_kasbank_detail', 'x_kredit', 'kredit', '`kredit`', '`kredit`', 20, -1, FALSE, '`kredit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_kasbank_detail`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v_kasbank_detaillist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_kasbank_detailview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_kasbank_detailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_kasbank_detailadd.php?" . $this->UrlParm($parm);
		else
			$url = "v_kasbank_detailadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("v_kasbank_detailedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("v_kasbank_detailadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_kasbank_detaildelete.php", $this->UrlParm());
	}
