...
ft_detaildelete.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_nama_akun","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"v_akun_jurnal"};
ft_detaildelete.Lists["x_anggota_id"] = {"LinkField":"x_anggota_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_anggota"};
...
<?php if ($t_detail->akun_id->Visible) { // akun_id ?>
		<th><span id="elh_t_detail_akun_id" class="t_detail_akun_id"><?php echo $t_detail->akun_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_detail->nilai->Visible) { // nilai ?>
		<th><span id="elh_t_detail_nilai" class="t_detail_nilai"><?php echo $t_detail->nilai->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($t_detail->akun_id->Visible) { // akun_id ?>
		<td<?php echo $t_detail->akun_id->CellAttributes() ?>>
<span id="el<?php echo $t_detail_delete->RowCnt ?>_t_detail_akun_id" class="t_detail_akun_id">
...
<?php } ?>
<?php if ($t_detail->nilai->Visible) { // nilai ?>
		<td<?php echo $t_detail->nilai->CellAttributes() ?>>
<span id="el<?php echo $t_detail_delete->RowCnt ?>_t_detail_nilai" class="t_detail_nilai">
