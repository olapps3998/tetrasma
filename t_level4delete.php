...
<?php if ($t_level4->saldo_awal->Visible) { // saldo_awal ?>
		<th><span id="elh_t_level4_saldo_awal" class="t_level4_saldo_awal"><?php echo $t_level4->saldo_awal->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($t_level4->saldo_awal->Visible) { // saldo_awal ?>
		<td<?php echo $t_level4->saldo_awal->CellAttributes() ?>>
<span id="el<?php echo $t_level4_delete->RowCnt ?>_t_level4_saldo_awal" class="t_level4_saldo_awal">
