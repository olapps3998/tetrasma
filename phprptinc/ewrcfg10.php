...
define("EWR_PROJECT_ID", "{0947E56A-59DA-4545-A2FF-20A7F7239C7D}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "tetrasma", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_tetrasma", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'VH5H64zrE5JQqL2o', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/tetrasma.css", TRUE); // Project stylesheet file name
...
define("EWR_TABLE_PREFIX", "{0947E56A-59DA-4545-A2FF-20A7F7239C7D}", TRUE);
