...
ft_jurnaldelete.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level4_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level4"};
ft_jurnaldelete.Lists["x_jenis_jurnal"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_jurnaldelete.Lists["x_jenis_jurnal"].Options = <?php echo json_encode($t_jurnal->jenis_jurnal->Options()) ?>;
...
<?php if ($t_jurnal->akun_id->Visible) { // akun_id ?>
		<th><span id="elh_t_jurnal_akun_id" class="t_jurnal_akun_id"><?php echo $t_jurnal->akun_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_jurnal->jenis_jurnal->Visible) { // jenis_jurnal ?>
		<th><span id="elh_t_jurnal_jenis_jurnal" class="t_jurnal_jenis_jurnal"><?php echo $t_jurnal->jenis_jurnal->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($t_jurnal->nilai->Visible) { // nilai ?>
		<th><span id="elh_t_jurnal_nilai" class="t_jurnal_nilai"><?php echo $t_jurnal->nilai->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $t_jurnal_delete->RowCnt ?>_t_jurnal_akun_id" class="t_jurnal_akun_id">
...
<span id="el<?php echo $t_jurnal_delete->RowCnt ?>_t_jurnal_jenis_jurnal" class="t_jurnal_jenis_jurnal">
...
<span id="el<?php echo $t_jurnal_delete->RowCnt ?>_t_jurnal_nilai" class="t_jurnal_nilai">
