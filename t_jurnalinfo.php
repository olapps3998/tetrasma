...
class ct_jurnal extends cTable {
	...
	function __construct() {
		...
		// akun_id
		$this->akun_id = new cField('t_jurnal', 't_jurnal', 'x_akun_id', 'akun_id', '`akun_id`', '`akun_id`', 3, -1, FALSE, '`EV__akun_id`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// jenis_jurnal
		$this->jenis_jurnal = new cField('t_jurnal', 't_jurnal', 'x_jenis_jurnal', 'jenis_jurnal', '`jenis_jurnal`', '`jenis_jurnal`', 200, -1, FALSE, '`jenis_jurnal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// tgl
		$this->tgl = new cField('t_jurnal', 't_jurnal', 'x_tgl', 'tgl', '`tgl`', ew_CastDateFieldForLike('`tgl`', 7, "DB"), 133, 7, FALSE, '`tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nilai
		$this->nilai = new cField('t_jurnal', 't_jurnal', 'x_nilai', 'nilai', '`nilai`', '`nilai`', 20, -1, FALSE, '`nilai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlSelectList() { // Select for List page
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `level4_nama` FROM `t_level4` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`level4_id` = `t_jurnal`.`akun_id` LIMIT 1) AS `EV__akun_id` FROM `t_jurnal`" .
			") `EW_TMP_TABLE`";
