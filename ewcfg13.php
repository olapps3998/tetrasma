...
define("EW_RANDOM_KEY", '6o3F6fTut3RJvKBd', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_tetrasma", "qs" => "`", "qe" => "`");
