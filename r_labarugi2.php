...
$r_labarugi2_php = NULL; // Initialize page object first

class cr_labarugi2_php {
	...
	// Table name
	var $TableName = 'r_labarugi2.php';

	// Page object name
	var $PageObjName = 'r_labarugi2_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'r_labarugi2.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "r_labarugi2_php", $url, "", "r_labarugi2_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($r_labarugi2_php)) $r_labarugi2_php = new cr_labarugi2_php();

// Page init
$r_labarugi2_php->Page_Init();

// Page main
$r_labarugi2_php->Page_Main();
...
if (!$rs->EOF) {
	...
	?>
	<tr><td colspan="3"><b>Total Pendapatan</b></td><td align="right"><b><?php echo number_format($pendapatan);?></b></td></tr>
	<?php
}
?>
...
if (!$rs->EOF) {
	...
	?>
	<tr><td colspan="3"><b>Total HPP</b></td><td align="right"><b><?php echo number_format($hpp);?></b></td></tr>
	<?php
}
$laba_kotor = $pendapatan - $hpp;
?>
<tr><td colspan="4">&nbsp;</td></tr>
<tr><td colspan="3"><b>Laba Kotor</b></td><td align="right"><b><?php echo number_format($laba_kotor);?></b></td></tr>
...
if (!$rs->EOF) {
	...
	?>
	<tr><td colspan="3"><b>Total Biaya</b></td><td align="right"><b><?php echo number_format(abs($biaya));?></b></td></tr>
	<?php
}
?>
...
<?php
$r_labarugi2_php->Page_Terminate();
?>
