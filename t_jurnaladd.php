...
ft_jurnaladd.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level4_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level4"};
ft_jurnaladd.Lists["x_jenis_jurnal"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_jurnaladd.Lists["x_jenis_jurnal"].Options = <?php echo json_encode($t_jurnal->jenis_jurnal->Options()) ?>;
...
<script type="text/javascript">
ew_CreateCalendar("ft_jurnaladd", "x_tgl", 7);
</script>
<?php } ?>
</span>
