...
class ct_detail_add extends ct_detail {
	...
	function RenderRow() {
		...
		$sSqlWrk = "SELECT `anggota_id`, `nama` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld` FROM `t_anggota`";
		$sWhereWrk = "";
	...
	function SetupLookupFilters($fld, $pageId = null) {
		...
		case "x_anggota_id":
			$sSqlWrk = "";
			$sSqlWrk = "SELECT `anggota_id` AS `LinkFld`, `nama` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld` FROM `t_anggota`";
			$sWhereWrk = "{filter}";
			$this->anggota_id->LookupFilters = array("dx1" => '`nama`');
	...
	function SetupAutoSuggestFilters($fld, $pageId = null) {
		...
		case "x_anggota_id":
			$sSqlWrk = "";
			$sSqlWrk = "SELECT `anggota_id`, `nama` AS `DispFld` FROM `t_anggota`";
...
ft_detailadd.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_nama_akun","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"v_akun_jurnal"};
ft_detailadd.Lists["x_anggota_id"] = {"LinkField":"x_anggota_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_anggota"};
...
<?php if ($t_detail->akun_id->Visible) { // akun_id ?>
	<div id="r_akun_id" class="form-group">
		<label id="elh_t_detail_akun_id" class="col-sm-2 control-label ewLabel"><?php echo $t_detail->akun_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t_detail->akun_id->CellAttributes() ?>>
<span id="el_t_detail_akun_id">
<?php
...
<span id="as_x_akun_id" style="white-space: nowrap; z-index: 8970">
	<input type="text" name="sv_x_akun_id" id="sv_x_akun_id" value="<?php echo $t_detail->akun_id->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($t_detail->akun_id->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($t_detail->akun_id->getPlaceHolder()) ?>"<?php echo $t_detail->akun_id->EditAttributes() ?>>
</span>
<input type="hidden" data-table="t_detail" data-field="x_akun_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $t_detail->akun_id->DisplayValueSeparatorAttribute() ?>" name="x_akun_id" id="x_akun_id" value="<?php echo ew_HtmlEncode($t_detail->akun_id->CurrentValue) ?>"<?php echo $wrkonchange ?>>
<input type="hidden" name="q_x_akun_id" id="q_x_akun_id" value="<?php echo $t_detail->akun_id->LookupFilterQuery(true) ?>">
<script type="text/javascript">
ft_detailadd.CreateAutoSuggest({"id":"x_akun_id","forceSelect":true});
</script>
...
<input type="hidden" name="s_x_akun_id" id="s_x_akun_id" value="<?php echo $t_detail->akun_id->LookupFilterQuery(false) ?>">
</span>
<?php echo $t_detail->akun_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_detail->nilai->Visible) { // nilai ?>
	<div id="r_nilai" class="form-group">
		<label id="elh_t_detail_nilai" for="x_nilai" class="col-sm-2 control-label ewLabel"><?php echo $t_detail->nilai->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t_detail->nilai->CellAttributes() ?>>
<span id="el_t_detail_nilai">
<input type="text" data-table="t_detail" data-field="x_nilai" name="x_nilai" id="x_nilai" size="30" placeholder="<?php echo ew_HtmlEncode($t_detail->nilai->getPlaceHolder()) ?>" value="<?php echo $t_detail->nilai->EditValue ?>"<?php echo $t_detail->nilai->EditAttributes() ?>>
</span>
<?php echo $t_detail->nilai->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_detail->anggota_id->Visible) { // anggota_id ?>
	<div id="r_anggota_id" class="form-group">
		<label id="elh_t_detail_anggota_id" class="col-sm-2 control-label ewLabel"><?php echo $t_detail->anggota_id->FldCaption() ?></label>
...
<span id="as_x_anggota_id" style="white-space: nowrap; z-index: 8950">
	<input type="text" name="sv_x_anggota_id" id="sv_x_anggota_id" value="<?php echo $t_detail->anggota_id->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($t_detail->anggota_id->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($t_detail->anggota_id->getPlaceHolder()) ?>"<?php echo $t_detail->anggota_id->EditAttributes() ?>>
</span>
<input type="hidden" data-table="t_detail" data-field="x_anggota_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $t_detail->anggota_id->DisplayValueSeparatorAttribute() ?>" name="x_anggota_id" id="x_anggota_id" value="<?php echo ew_HtmlEncode($t_detail->anggota_id->CurrentValue) ?>"<?php echo $wrkonchange ?>>
<input type="hidden" name="q_x_anggota_id" id="q_x_anggota_id" value="<?php echo $t_detail->anggota_id->LookupFilterQuery(true) ?>">
<script type="text/javascript">
ft_detailadd.CreateAutoSuggest({"id":"x_anggota_id","forceSelect":true});
</script>
...
<input type="hidden" name="s_x_anggota_id" id="s_x_anggota_id" value="<?php echo $t_detail->anggota_id->LookupFilterQuery(false) ?>">
</span>
<?php echo $t_detail->anggota_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (strval($t_detail->jurnal_id->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_jurnal_id" id="x_jurnal_id" value="<?php echo ew_HtmlEncode(strval($t_detail->jurnal_id->getSessionValue())) ?>">
<?php } ?>
<?php if (!$t_detail_add->IsModal) { ?>
