...
$t_level4_edit = NULL; // Initialize page object first

class ct_level4_edit extends ct_level4 {
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("t_level4list.php"); // Return to list page
			...
			while (!$this->Recordset->EOF) {
				if (strval($this->level4_id->CurrentValue) == strval($this->Recordset->fields('level4_id'))) {
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if (ew_GetPageName($sReturnUrl) == "t_level4list.php")
...
// Create page object
if (!isset($t_level4_edit)) $t_level4_edit = new ct_level4_edit();

// Page init
$t_level4_edit->Page_Init();

// Page main
$t_level4_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_level4_edit->Page_Render();
?>
...
var CurrentForm = ft_level4edit = new ew_Form("ft_level4edit", "edit");

// Validate form
ft_level4edit.Validate = function() {
...
ft_level4edit.Form_CustomValidate = 
...
ft_level4edit.ValidateRequired = true;
<?php } else { ?>
ft_level4edit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_level4edit.Lists["x_level1_id"] = {"LinkField":"x_level1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level1_no","x_level1_nama","",""],"ParentFields":[],"ChildFields":["x_level2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level1"};
ft_level4edit.Lists["x_level2_id"] = {"LinkField":"x_level2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level2_no","x_level2_nama","",""],"ParentFields":["x_level1_id"],"ChildFields":["x_level3_id"],"FilterFields":["x_level1_id"],"Options":[],"Template":"","LinkTable":"t_level2"};
ft_level4edit.Lists["x_level3_id"] = {"LinkField":"x_level3_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level3_no","x_level3_nama","",""],"ParentFields":["x_level2_id"],"ChildFields":[],"FilterFields":["x_level2_id"],"Options":[],"Template":"","LinkTable":"t_level3"};
ft_level4edit.Lists["x_jurnal"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_level4edit.Lists["x_jurnal"].Options = <?php echo json_encode($t_level4->jurnal->Options()) ?>;
ft_level4edit.Lists["x_jurnal_kode"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_level4edit.Lists["x_jurnal_kode"].Options = <?php echo json_encode($t_level4->jurnal_kode->Options()) ?>;
ft_level4edit.Lists["x_neraca"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_level4edit.Lists["x_neraca"].Options = <?php echo json_encode($t_level4->neraca->Options()) ?>;
ft_level4edit.Lists["x_labarugi"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_level4edit.Lists["x_labarugi"].Options = <?php echo json_encode($t_level4->labarugi->Options()) ?>;
...
<?php } ?>
<?php $t_level4_edit->ShowPageHeader(); ?>
<?php
$t_level4_edit->ShowMessage();
?>
<?php if (!$t_level4_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_level4_edit->Pager)) $t_level4_edit->Pager = new cPrevNextPager($t_level4_edit->StartRec, $t_level4_edit->DisplayRecs, $t_level4_edit->TotalRecs) ?>
<?php if ($t_level4_edit->Pager->RecordCount > 0 && $t_level4_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_level4_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_level4_edit->PageUrl() ?>start=<?php echo $t_level4_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_level4_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_level4_edit->PageUrl() ?>start=<?php echo $t_level4_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_level4_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_level4_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_level4_edit->PageUrl() ?>start=<?php echo $t_level4_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_level4_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_level4_edit->PageUrl() ?>start=<?php echo $t_level4_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_level4_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft_level4edit" id="ft_level4edit" class="<?php echo $t_level4_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_level4_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_level4_edit->Token ?>">
<?php } ?>
...
<?php if ($t_level4->level1_id->Visible) { // level1_id ?>
	<div id="r_level1_id" class="form-group">
		<label id="elh_t_level4_level1_id" class="col-sm-2 control-label ewLabel"><?php echo $t_level4->level1_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t_level4->level1_id->CellAttributes() ?>>
<span id="el_t_level4_level1_id">
<?php
...
<span id="as_x_level1_id" style="white-space: nowrap; z-index: 8980">
	<input type="text" name="sv_x_level1_id" id="sv_x_level1_id" value="<?php echo $t_level4->level1_id->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($t_level4->level1_id->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($t_level4->level1_id->getPlaceHolder()) ?>"<?php echo $t_level4->level1_id->EditAttributes() ?>>
</span>
<input type="hidden" data-table="t_level4" data-field="x_level1_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $t_level4->level1_id->DisplayValueSeparatorAttribute() ?>" name="x_level1_id" id="x_level1_id" value="<?php echo ew_HtmlEncode($t_level4->level1_id->CurrentValue) ?>"<?php echo $wrkonchange ?>>
<input type="hidden" name="q_x_level1_id" id="q_x_level1_id" value="<?php echo $t_level4->level1_id->LookupFilterQuery(true) ?>">
<script type="text/javascript">
ft_level4edit.CreateAutoSuggest({"id":"x_level1_id","forceSelect":true});
</script>
...
<input type="hidden" name="s_x_level1_id" id="s_x_level1_id" value="<?php echo $t_level4->level1_id->LookupFilterQuery(false) ?>">
</span>
<?php echo $t_level4->level1_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_level4->level2_id->Visible) { // level2_id ?>
	<div id="r_level2_id" class="form-group">
		<label id="elh_t_level4_level2_id" class="col-sm-2 control-label ewLabel"><?php echo $t_level4->level2_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t_level4->level2_id->CellAttributes() ?>>
<span id="el_t_level4_level2_id">
<?php
...
<span id="as_x_level2_id" style="white-space: nowrap; z-index: 8970">
	<input type="text" name="sv_x_level2_id" id="sv_x_level2_id" value="<?php echo $t_level4->level2_id->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($t_level4->level2_id->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($t_level4->level2_id->getPlaceHolder()) ?>"<?php echo $t_level4->level2_id->EditAttributes() ?>>
</span>
<input type="hidden" data-table="t_level4" data-field="x_level2_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $t_level4->level2_id->DisplayValueSeparatorAttribute() ?>" name="x_level2_id" id="x_level2_id" value="<?php echo ew_HtmlEncode($t_level4->level2_id->CurrentValue) ?>"<?php echo $wrkonchange ?>>
<input type="hidden" name="q_x_level2_id" id="q_x_level2_id" value="<?php echo $t_level4->level2_id->LookupFilterQuery(true) ?>">
<script type="text/javascript">
ft_level4edit.CreateAutoSuggest({"id":"x_level2_id","forceSelect":true});
</script>
...
<input type="hidden" name="s_x_level2_id" id="s_x_level2_id" value="<?php echo $t_level4->level2_id->LookupFilterQuery(false) ?>">
</span>
<?php echo $t_level4->level2_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_level4->level3_id->Visible) { // level3_id ?>
	<div id="r_level3_id" class="form-group">
		<label id="elh_t_level4_level3_id" class="col-sm-2 control-label ewLabel"><?php echo $t_level4->level3_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t_level4->level3_id->CellAttributes() ?>>
<span id="el_t_level4_level3_id">
<?php
...
<span id="as_x_level3_id" style="white-space: nowrap; z-index: 8960">
	<input type="text" name="sv_x_level3_id" id="sv_x_level3_id" value="<?php echo $t_level4->level3_id->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($t_level4->level3_id->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($t_level4->level3_id->getPlaceHolder()) ?>"<?php echo $t_level4->level3_id->EditAttributes() ?>>
</span>
<input type="hidden" data-table="t_level4" data-field="x_level3_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $t_level4->level3_id->DisplayValueSeparatorAttribute() ?>" name="x_level3_id" id="x_level3_id" value="<?php echo ew_HtmlEncode($t_level4->level3_id->CurrentValue) ?>"<?php echo $wrkonchange ?>>
<input type="hidden" name="q_x_level3_id" id="q_x_level3_id" value="<?php echo $t_level4->level3_id->LookupFilterQuery(true) ?>">
<script type="text/javascript">
ft_level4edit.CreateAutoSuggest({"id":"x_level3_id","forceSelect":true});
</script>
...
<input type="hidden" name="s_x_level3_id" id="s_x_level3_id" value="<?php echo $t_level4->level3_id->LookupFilterQuery(false) ?>">
</span>
<?php echo $t_level4->level3_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_level4->level4_no->Visible) { // level4_no ?>
	<div id="r_level4_no" class="form-group">
		<label id="elh_t_level4_level4_no" for="x_level4_no" class="col-sm-2 control-label ewLabel"><?php echo $t_level4->level4_no->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t_level4->level4_no->CellAttributes() ?>>
<span id="el_t_level4_level4_no">
<input type="text" data-table="t_level4" data-field="x_level4_no" name="x_level4_no" id="x_level4_no" size="30" maxlength="2" placeholder="<?php echo ew_HtmlEncode($t_level4->level4_no->getPlaceHolder()) ?>" value="<?php echo $t_level4->level4_no->EditValue ?>"<?php echo $t_level4->level4_no->EditAttributes() ?>>
</span>
<?php echo $t_level4->level4_no->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_level4->level4_nama->Visible) { // level4_nama ?>
	<div id="r_level4_nama" class="form-group">
		<label id="elh_t_level4_level4_nama" for="x_level4_nama" class="col-sm-2 control-label ewLabel"><?php echo $t_level4->level4_nama->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t_level4->level4_nama->CellAttributes() ?>>
<span id="el_t_level4_level4_nama">
<input type="text" data-table="t_level4" data-field="x_level4_nama" name="x_level4_nama" id="x_level4_nama" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($t_level4->level4_nama->getPlaceHolder()) ?>" value="<?php echo $t_level4->level4_nama->EditValue ?>"<?php echo $t_level4->level4_nama->EditAttributes() ?>>
</span>
<?php echo $t_level4->level4_nama->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_level4->sa_debet->Visible) { // sa_debet ?>
	<div id="r_sa_debet" class="form-group">
		<label id="elh_t_level4_sa_debet" for="x_sa_debet" class="col-sm-2 control-label ewLabel"><?php echo $t_level4->sa_debet->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t_level4->sa_debet->CellAttributes() ?>>
<span id="el_t_level4_sa_debet">
<input type="text" data-table="t_level4" data-field="x_sa_debet" name="x_sa_debet" id="x_sa_debet" size="30" placeholder="<?php echo ew_HtmlEncode($t_level4->sa_debet->getPlaceHolder()) ?>" value="<?php echo $t_level4->sa_debet->EditValue ?>"<?php echo $t_level4->sa_debet->EditAttributes() ?>>
</span>
<?php echo $t_level4->sa_debet->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_level4->sa_kredit->Visible) { // sa_kredit ?>
	<div id="r_sa_kredit" class="form-group">
		<label id="elh_t_level4_sa_kredit" for="x_sa_kredit" class="col-sm-2 control-label ewLabel"><?php echo $t_level4->sa_kredit->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t_level4->sa_kredit->CellAttributes() ?>>
<span id="el_t_level4_sa_kredit">
<input type="text" data-table="t_level4" data-field="x_sa_kredit" name="x_sa_kredit" id="x_sa_kredit" size="30" placeholder="<?php echo ew_HtmlEncode($t_level4->sa_kredit->getPlaceHolder()) ?>" value="<?php echo $t_level4->sa_kredit->EditValue ?>"<?php echo $t_level4->sa_kredit->EditAttributes() ?>>
</span>
<?php echo $t_level4->sa_kredit->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_level4->jurnal->Visible) { // jurnal ?>
	<div id="r_jurnal" class="form-group">
		<label id="elh_t_level4_jurnal" class="col-sm-2 control-label ewLabel"><?php echo $t_level4->jurnal->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t_level4->jurnal->CellAttributes() ?>>
<span id="el_t_level4_jurnal">
<div id="tp_x_jurnal" class="ewTemplate"><input type="radio" data-table="t_level4" data-field="x_jurnal" data-value-separator="<?php echo $t_level4->jurnal->DisplayValueSeparatorAttribute() ?>" name="x_jurnal" id="x_jurnal" value="{value}"<?php echo $t_level4->jurnal->EditAttributes() ?>></div>
<div id="dsl_x_jurnal" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $t_level4->jurnal->RadioButtonListHtml(FALSE, "x_jurnal") ?>
</div></div>
</span>
<?php echo $t_level4->jurnal->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_level4->jurnal_kode->Visible) { // jurnal_kode ?>
	<div id="r_jurnal_kode" class="form-group">
		<label id="elh_t_level4_jurnal_kode" class="col-sm-2 control-label ewLabel"><?php echo $t_level4->jurnal_kode->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t_level4->jurnal_kode->CellAttributes() ?>>
<span id="el_t_level4_jurnal_kode">
<div id="tp_x_jurnal_kode" class="ewTemplate"><input type="radio" data-table="t_level4" data-field="x_jurnal_kode" data-value-separator="<?php echo $t_level4->jurnal_kode->DisplayValueSeparatorAttribute() ?>" name="x_jurnal_kode" id="x_jurnal_kode" value="{value}"<?php echo $t_level4->jurnal_kode->EditAttributes() ?>></div>
<div id="dsl_x_jurnal_kode" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $t_level4->jurnal_kode->RadioButtonListHtml(FALSE, "x_jurnal_kode") ?>
</div></div>
</span>
...
<input type="hidden" data-table="t_level4" data-field="x_level4_id" name="x_level4_id" id="x_level4_id" value="<?php echo ew_HtmlEncode($t_level4->level4_id->CurrentValue) ?>">
<?php if (!$t_level4_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_level4_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t_level4_edit->Pager)) $t_level4_edit->Pager = new cPrevNextPager($t_level4_edit->StartRec, $t_level4_edit->DisplayRecs, $t_level4_edit->TotalRecs) ?>
<?php if ($t_level4_edit->Pager->RecordCount > 0 && $t_level4_edit->Pager->Visible) { ?>
