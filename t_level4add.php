...
$t_level4_add = NULL; // Initialize page object first

class ct_level4_add extends ct_level4 {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_level4list.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_level4view.php")
...
// Create page object
if (!isset($t_level4_add)) $t_level4_add = new ct_level4_add();

// Page init
$t_level4_add->Page_Init();

// Page main
$t_level4_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_level4_add->Page_Render();
?>
...
var CurrentForm = ft_level4add = new ew_Form("ft_level4add", "add");

// Validate form
ft_level4add.Validate = function() {
...
ft_level4add.Form_CustomValidate = 
...
ft_level4add.ValidateRequired = true;
<?php } else { ?>
ft_level4add.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_level4add.Lists["x_level1_id"] = {"LinkField":"x_level1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level1_no","x_level1_nama","",""],"ParentFields":[],"ChildFields":["x_level2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level1"};
ft_level4add.Lists["x_level2_id"] = {"LinkField":"x_level2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level2_no","x_level2_nama","",""],"ParentFields":["x_level1_id"],"ChildFields":["x_level3_id"],"FilterFields":["x_level1_id"],"Options":[],"Template":"","LinkTable":"t_level2"};
ft_level4add.Lists["x_level3_id"] = {"LinkField":"x_level3_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level3_no","x_level3_nama","",""],"ParentFields":["x_level2_id"],"ChildFields":[],"FilterFields":["x_level2_id"],"Options":[],"Template":"","LinkTable":"t_level3"};
ft_level4add.Lists["x_jurnal"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php } ?>
<?php $t_level4_add->ShowPageHeader(); ?>
<?php
$t_level4_add->ShowMessage();
?>
<form name="ft_level4add" id="ft_level4add" class="<?php echo $t_level4_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_level4_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_level4_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ft_level4add.CreateAutoSuggest({"id":"x_level1_id","forceSelect":true});
</script>
...
<script type="text/javascript">
ft_level4add.CreateAutoSuggest({"id":"x_level2_id","forceSelect":true});
</script>
...
<script type="text/javascript">
ft_level4add.CreateAutoSuggest({"id":"x_level3_id","forceSelect":true});
</script>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_level4_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
