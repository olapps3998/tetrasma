...
ft_detaillist.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_nama_akun","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"v_akun_jurnal"};
ft_detaillist.Lists["x_anggota_id"] = {"LinkField":"x_anggota_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_anggota"};
...
<?php if ($t_detail_list->TotalRecs > 0 || $t_detail->CurrentAction == "gridedit") { ?>
...
<span id="el<?php echo $t_detail_list->RowCnt ?>_t_detail_akun_id" class="t_detail_akun_id">
...
<span id="el<?php echo $t_detail_list->RowCnt ?>_t_detail_nilai" class="t_detail_nilai">
...
<?php
	...
	if ($t_detail->CurrentAction <> "gridadd")
		$t_detail_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
