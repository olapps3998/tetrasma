...
//
// Table class for v_akun_jurnal
//
class cv_akun_jurnal extends cTable {
	var $level4_id;
	var $no_nama_akun;
	var $jurnal;
	var $jurnal_kode;
	...
	function __construct() {
		...
		$this->TableVar = 'v_akun_jurnal';
		$this->TableName = 'v_akun_jurnal';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_akun_jurnal`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// level4_id
		$this->level4_id = new cField('v_akun_jurnal', 'v_akun_jurnal', 'x_level4_id', 'level4_id', '`level4_id`', '`level4_id`', 3, -1, FALSE, '`level4_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// no_nama_akun
		$this->no_nama_akun = new cField('v_akun_jurnal', 'v_akun_jurnal', 'x_no_nama_akun', 'no_nama_akun', '`no_nama_akun`', '`no_nama_akun`', 200, -1, FALSE, '`no_nama_akun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_nama_akun->Sortable = TRUE; // Allow sort
		$this->fields['no_nama_akun'] = &$this->no_nama_akun;

		// jurnal
		$this->jurnal = new cField('v_akun_jurnal', 'v_akun_jurnal', 'x_jurnal', 'jurnal', '`jurnal`', '`jurnal`', 16, -1, FALSE, '`jurnal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// jurnal_kode
		$this->jurnal_kode = new cField('v_akun_jurnal', 'v_akun_jurnal', 'x_jurnal_kode', 'jurnal_kode', '`jurnal_kode`', '`jurnal_kode`', 200, -1, FALSE, '`jurnal_kode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_akun_jurnalview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_akun_jurnalview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_akun_jurnaladd.php?" . $this->UrlParm($parm);
		else
			$url = "v_akun_jurnaladd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("v_akun_jurnaledit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("v_akun_jurnaladd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_akun_jurnaldelete.php", $this->UrlParm());
	}
