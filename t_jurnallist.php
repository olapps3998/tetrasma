...
ft_jurnallist.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level4_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_level4"};
ft_jurnallist.Lists["x_jenis_jurnal"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_jurnallist.Lists["x_jenis_jurnal"].Options = <?php echo json_encode($t_jurnal->jenis_jurnal->Options()) ?>;
...
<?php if ($t_jurnal_list->TotalRecs > 0 || $t_jurnal->CurrentAction == "gridedit") { ?>
...
<span id="el<?php echo $t_jurnal_list->RowCnt ?>_t_jurnal_akun_id" class="t_jurnal_akun_id">
...
<span id="el<?php echo $t_jurnal_list->RowCnt ?>_t_jurnal_jenis_jurnal" class="t_jurnal_jenis_jurnal">
...
<span id="el<?php echo $t_jurnal_list->RowCnt ?>_t_jurnal_nilai" class="t_jurnal_nilai">
...
<?php
	...
	if ($t_jurnal->CurrentAction <> "gridadd")
		$t_jurnal_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
